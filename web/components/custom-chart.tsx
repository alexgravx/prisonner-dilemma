...
export function ArenaChart(
  ...
  const checkServerStatus = async () => {
    try {
      const response = await fetch(`https://${process.env.NEXT_PUBLIC_BACKEND_URL}:${process.env.NEXT_PUBLIC_BACKEND_PORT}/api/ping`);
  ...
  useEffect(() => {
    async function getChartData(
      ...
      const url = new URL(`https://${process.env.NEXT_PUBLIC_BACKEND_URL}:${process.env.NEXT_PUBLIC_BACKEND_PORT}/api/arena`);
